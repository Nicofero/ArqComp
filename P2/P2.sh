...
plot(N,a,col=2,type=\"l\",\"Speedup entre Ej1 y Ej2\",ylab=\"Speedup\")
abline(med,0,lty=2)
legend(\"topright\",legend=\"Speedup\",col=2,lwd=2,bty=\n\")
...
b=C0_03/C3
c=C0_03/C4
plot(N,a,col=5,type=\"l\",lwd=2,main=\"Speedup entre -O3 y el resto de versiones\",ylab=\"Speedup\")
lines(N,b,col=6)
lines(N,c,col=7)
legend(\"topright\",legend=c(\"Ej2\",\"Ej3\",\"Ej4\"),col=5:7,lwd=2,bty=\"n\")">>ex.r
