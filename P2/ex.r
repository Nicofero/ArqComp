...
C2_b=c(4556196.000000,17988219.000000,34196896.000000,67989396.000000,144535903.000000,231942607.000000,379368153.000000,526174045.000000)
...
#Grafica blocking
plot(N,C2,col=5,type="l",main="Comparación entre el uso o no de blocking",ylab="Ciclos de reloj")
lines(N,C2_b,col=6)
